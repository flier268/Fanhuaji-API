...
namespace Fanhuaji_API
{
    public class Config
    {
        ...
        /// 對於日文樣式該如何處理
        /// </summary>
        [ColumnName("jpStyleConversionStrategy")]
        public Enum_jpConversionStrategy JpStyleConversionStrategy { get; set; }
        /// <summary>
        /// 對於繁化姬自己發現的日文區域該如何處理
        /// </summary>
        [ColumnName("jpTextConversionStrategy")]
